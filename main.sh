    ...
    case $opcion in
        ...
        2)
            ...
            if [ -f "$HOME/EPNro1/consolidar.sh" ]; then
                ...
                echo "No existe el script. Tenés que crear el entorno"
            fi
            ;;
        ...
        5)
            ...
            if [ -d "$HOME/EPNro1" ]; then
                ...
                if [ -f "$archivo" ]; then
                    read -p "Ingresá el número del padrón: " padron
        ...
        7)
            clear
            ;;
        # Si la opción ingresada no es un número del 1 al 7.
        *)
            clear
            echo "Por favor ingresá un número del 1 al 7."
            ;;
    esac
done
